                            ...
                            <ul className="space-y-1">
                                <li>
                                    <div className="flex items-center gap-2 rounded-lg  px-4 py-2 text-gray-700">
                                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 opacity-75 text-slate-50" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                ...
                                <li>
                                    <div className="flex items-center gap-2 rounded-lg  px-4 py-2 text-gray-700">
                                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 opacity-75 text-slate-50" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                ...
                                <li>
                                    <div className="flex items-center gap-2 rounded-lg  px-4 py-2 text-gray-700">
                                        <svg xmlns="http://www.w3.org/2000/svg" classnName="h-5 w-5 opacity-75 text-slate-50" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
