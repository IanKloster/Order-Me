...
export default function Precios() {
    return (
        <>
            <HeaderPrecios/>
            <div className="max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-12 m-auto">
                ...
                <div className="card-info-fiv_hijo divide-y divide-gray-200 rounded-2xl border border-gray-200 shadow-sm">
                        <div className="card-price p-6 sm:px-8">
                            ...
                            <p className="price-text">Todas nuestras instalaciones y capacitaciones son bonificadas, tanto para clientes de prueba como para nuevas terminales de clientes existentes.</p>
                            <a
