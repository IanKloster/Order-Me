export default function Clientes() {
  return (
    <>
      ...
      <section className="clientes-container flex justify-center items-center flex-col pt-16 pb-12 md:pb-0 ">
        ...
        <a href="https://www.instagram.com/humo.patiodecarnes/" target="_blank">  <img className="rounded-xl" width="200px" src="/humo-patio-de-carnes.webp" alt="Logo de Humo" /> </a>
      </div>
      </section>
