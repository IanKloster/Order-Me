        ...
        <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
          <div className="mx-auto max-w-lg text-center">
            ...
            <p className="mt-4 text-gray-300">
              OrderMe es más que un software, es tu herramienta dedicada a
              optimizar la gestión de tu comercio gastronómico o minimercado.
              Con un diseño intuitivo y funciones poderosas, OrderMe está
              pensado para agilizar tus operaciones diarias.
            </p>
          </div>
